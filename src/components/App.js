...
class App extends Component {
  ...
  componentDidMount = async () => {
    try {
      ...
      const instanceTestNFT = new web3.eth.Contract(
        TestNFTContract.abi,
        "0x8f4CA85d996fC878c81b4367F19b3E0d8CEA3056"
      );
      ...
      const instanceSwap = new web3.eth.Contract(
        Swap.abi,
        "0x4cfd3F97087980EF61f80Ba689ae51734CD01f76",
      );
  ...
  proposeTrade = async (event) => { // add approval check beforehand
    ...
    for(var i = 0; i < this.state.offeredNFTIds.length; i++) {
      ...
      offerContractArr[i] = "0x8f4CA85d996fC878c81b4367F19b3E0d8CEA3056";//this.state.contractNFT.address;
    }

    for(var i = 0; i < this.state.askedNFTIds.length; i++) {
      askContractArr[i] = "0x8f4CA85d996fC878c81b4367F19b3E0d8CEA3056";//this.state.contractNFT.address;
    }
